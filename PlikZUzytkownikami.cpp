...
{
    string liniaZDanymiUzytownika = zamienDaneUzytkownikaNaLinieZDanymiOddzielonaPionowymiKreskami(uzytkownik);
    PlikTekstowy::dopiszDoPliku(liniaZDanymiUzytownika);
}
